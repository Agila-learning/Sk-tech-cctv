...
import { View, Text, StyleSheet, FlatList, StatusBar, RefreshControl, TextInput, TouchableOpacity } from 'react-native';
  ...
  return (
    <View style={s.root}><StatusBar barStyle="light-content" backgroundColor={Colors.background} />
      ...
      <FlatList data={filteredData} keyExtractor={(i, idx) => i._id || idx.toString()} refreshControl={<RefreshControl refreshing={loading} onRefresh={load} tintColor={Colors.primary} />}
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={s.card} onPress={() => alert(`Location: ${item.locationName || 'In Transit'}`)}>
