...
export default function ServiceRequestsScreen() {
  ...
  const load = async () => {
    try { 
      setLoading(true); 
      const d = await fetchWithAuth('/bookings/my-bookings'); 
      setData(d || []); 
    } catch (e: any) { 
      console.error(e); 
            ...
            <View style={{ padding: 24, gap: 16 }}>
              ...
              <View style={s.detailRow}>
                ...
                <View style={s.detailTextContainer}>
                  ...
                  <Text style={s.dVal}>{selected?.customerName || 'N/A'} ({selected?.contactNumber || 'No contact'})</Text>
                </View>
              </View>
              ...
              <View style={s.detailRow}>
                ...
                <View style={s.detailTextContainer}>
                  ...
                  <Text style={s.dVal}>{selected?.address || 'No address provided'}</Text>
                </View>
              </View>
              ...
              <View style={s.responseCard}>
                ...
                <View style={s.responseItem}>
                  ...
                  <Text style={[s.rVal, !selected?.technicianResponse && s.rNone]}>
                    {selected?.technicianResponse || 'No response from technician yet.'}
                  </Text>
                </View>

                <View style={s.responseItem}>
                  <Text style={s.rLabel}>Admin Response:</Text>
                  <Text style={[s.rVal, !selected?.adminResponse && s.rNone]}>
                    {selected?.adminResponse || 'No response from admin yet.'}
                  </Text>
                </View>
