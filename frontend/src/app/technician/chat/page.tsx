    ...
    try {
      ...
      combine.forEach(item => {
        ...
        if (customer && customer._id) {
          custMap.set(customer._id, { ...customer, orderStatus });
        } else if (customer && typeof customer === 'string') {
          custMap.set(customer, { _id: customer, name: item.customerName || 'Active Customer', phone: item.contactNumber || item.phone || 'N/A', orderStatus });
        }
      });
