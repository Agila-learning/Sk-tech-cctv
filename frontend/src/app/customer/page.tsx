                          ...
                          {order.installationRequired && (
                            <div className="mt-8 pt-6 border-t border-border-subtle flex flex-wrap items-center justify-between gap-4">
                              <span className="flex items-center gap-2 text-blue-600 text-[10px] font-black uppercase tracking-widest bg-blue-500/5 px-4 py-2 rounded-xl border border-blue-500/10">
                                <Activity className="h-3.5 w-3.5 animate-pulse" /> Support Protocol Active
                              </span>
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 30 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 30 }} className="relative w-full max-w-lg bg-bg-surface border border-border-base rounded-[3rem] p-12 shadow-2xl space-y-8 overflow-hidden">
               ...
               <div className="text-center space-y-4">
                  ...
                  <h3 className="text-3xl font-black text-fg-primary uppercase tracking-tighter italic">Schedule <span className="text-yellow-500 non-italic">Adjustment</span></h3>
                  <p className="text-fg-muted font-black text-[10px] uppercase tracking-widest italic">Requesting deployment recalibration</p>
               </div>
               
               <div className="space-y-6">
                  <div className="space-y-2">
                     <label className="text-[9px] font-black text-fg-muted uppercase tracking-widest ml-4">Strategic Date</label>
                     <input 
                        type="date" 
                  ...
                  <div className="space-y-2">
                     <label className="text-[9px] font-black text-fg-muted uppercase tracking-widest ml-4">Operational Reason</label>
                     <textarea 
                        rows={3}
