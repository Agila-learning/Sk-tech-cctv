    ...
    <div className="min-h-screen bg-background flex transition-all duration-500 overflow-x-hidden">
      ...
      <main className="flex-1 lg:ml-80 p-6 md:p-12 overflow-y-auto w-full">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 gap-8">
          <div className="flex items-center gap-6">
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase leading-none italic">Admin <span className="text-blue-500 non-italic">Home</span></h1>
              <p className="text-fg-muted text-lg md:text-xl font-medium uppercase tracking-widest">Global Operations Command Center</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-20">
          ...
          <DashboardCard title="Subscribers" value={subscriptions.length} subValue="Stay Connected" icon={Globe} color="green" trend="+2.1% New" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-20">
          <div className="lg:col-span-8 space-y-16">
             <div className="space-y-12">
                <div className="flex justify-between items-end">
                   <div className="space-y-2">
                      ...
                      <p className="text-fg-muted text-sm font-medium uppercase tracking-widest">Dynamic Service Performance Logistics</p>
                   </div>
             ...
             <div className="space-y-12">
                <div className="flex justify-between items-center">
                   <h3 className="text-3xl font-black tracking-tight uppercase italic leading-none text-fg-primary">Field <span className="text-fg-muted not-italic">Operatives</span></h3>
                   <button className="px-8 py-5 bg-bg-muted border border-border-base text-fg-primary rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-blue-600 hover:text-white transition-all shadow-xl">Full Deployment Map</button>
                </div>
