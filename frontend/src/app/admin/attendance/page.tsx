...
import { 
  ...
  ChevronLeft, ChevronRight, User as UserIcon, CheckCircle2, XCircle, AlertCircle
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-background p-8 lg:p-12 space-y-12">
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-10">
        <div className="space-y-4">
          <h1 className="text-6xl lg:text-8xl font-black text-fg-primary uppercase tracking-tighter italic leading-none">Command <span className="text-blue-500 non-italic">Log</span></h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-12 space-y-8">
          ...
          <div className="bg-card rounded-[3.5rem] border border-card-border overflow-x-auto shadow-2xl relative">
