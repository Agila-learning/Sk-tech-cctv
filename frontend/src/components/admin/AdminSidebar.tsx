          ...
          <div className="h-[85px] relative flex items-center space-x-3 px-5 border-b border-black/5 dark:border-white/5 flex-shrink-0">
            ...
            <div className="lg:hidden flex items-center space-x-2 ml-auto shrink-0 relative z-[70]">
              <button 
                ...
                className="p-2 bg-black/10 dark:bg-white/10 rounded-xl hover:bg-black/20 dark:hover:bg-white/20 text-slate-900 dark:text-white transition-all flex items-center justify-center w-10 h-10 relative z-[100] cursor-pointer touch-manipulation"
              >
