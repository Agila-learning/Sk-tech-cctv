        ...
        <body>
          ...
          <div class="payment-section">
            <div class="bank-details">
              ...
              <p>Bank: AXIS BANK, THIYAGARASANAPALLI</p>
              <p>A/c Name: SK TECHNOLOGY</p>
              <p>A/c No: 924020061649159</p>
              <p>IFSC Code: UTIB0004965</p>
            </div>
            <div class="qr-section">
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=upi://pay?pa=sktechnology@ybl%26pn=SK%20Technology%26cu=INR" class="qr-img" />
              <div class="qr-text">SCAN TO PAY</div>
              <div class="qr-apps">GPay | PhonePe | Paytm | UPI</div>
              <div class="qr-sub">NetBanking also accepted</div>
            </div>
            <div class="signatory">
