...
import { View, Text, StyleSheet, ScrollView, StatusBar, RefreshControl, TouchableOpacity, Dimensions } from 'react-native';
    ...
    <View style={s2.root}><StatusBar barStyle="light-content" backgroundColor={Colors.background} />
      <ScrollView refreshControl={<RefreshControl refreshing={loading} onRefresh={load} tintColor={Colors.primary} />} showsVerticalScrollIndicator={false}>
        <View style={s2.hdr}>
          ...
          <TouchableOpacity style={s2.bellBtn}><Bell color={Colors.fgMuted} size={20} /></TouchableOpacity>
        </View>
        <View style={s2.sr}>
